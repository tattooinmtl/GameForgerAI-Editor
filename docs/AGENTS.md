...
|---|---|---|
| **Full-Stack Senior Architecture & Implementation** | [`supercoder`](file:///C:/.skills/skills/supercoder)<br>[`coder-ai-senior-developer`](file:///C:/.skills/skills/coder-ai-senior-developer)<br>[`mini-coder-max`](file:///C:/.skills/skills/mini-coder-max) | Production-ready architecture, high-performance C++/C#/Web implementations, clean code, SOLID principles, and system design. |
| **Superpowers Process & Governance** | [`superpowers`](file:///C:/.skills/skills/superpowers)<br>[`using-superpowers`](file:///C:/.skills/skills/using-superpowers) | Disciplined engineering framework: mandatory planning, structured debugging, TDD, and verification checkpoints. |
...
* **Configure & Build Editor (Debug):**
  ...
  .\Build-Project.cmd
  ```
  *(Or via CMake CLI: `cmake --preset windows-x64 && cmake --build --preset editor-debug`)*
